...
<div style="border-left: 4px solid #ff0000; padding: 0.5em;">
   <strong>❌ Error:</strong> No tocar en ningún caso la opción "Girar clave". Esto reinicia la clave y puede dañar el resto de proyectos que la utilicen.
</div>
